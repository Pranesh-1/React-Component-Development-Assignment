...
export interface InputFieldProps {
  ...
  onClear?: () => void; // optional clear handler from parent
}
...
const sizeClasses: Record<NonNullable<InputFieldProps['size']>, string> = {
  ...
  // Extra right padding so the input text doesn't go under the action buttons
  ...
  // helpers to prevent losing focus when clicking buttons
